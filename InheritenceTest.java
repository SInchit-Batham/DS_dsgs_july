...
public class InheritenceTest {
	...
	public static void main(String[] args) {
		...
		pancard1.setPanCard("EQQPB0965X", " Arun", "Income Tax Department");
...
class Employee extends Student //isA
{
	...
	class PanCard{
		...
		String Name;
		String issuedBy;
		public void setPanCard(String PanNumber, String name, String issuedBy)
		{
		...
		void printPanCard()
		{
			System.out.println("PanCard Number is :"+ PanNumber);
			System.out.println("Name on PanCard :"+ Name);
			System.out.println("PanCard issued By :"+ issuedBy);
