...
<%
       ...
       {
              out.print("Enter the id of any state");
       }
       else
       {
              ...
              try
              {
                     ...
                     Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/mysql","root","9956213345");
                     System.out.println("Connected...");
                     
                     PreparedStatement ps=con.prepareStatement("select * from state where stateid=?");
                     ps.setInt(1,id);
                     ResultSet rs=ps.executeQuery();
                     System.out.println("Query Initiated and Recieved the result.....");
